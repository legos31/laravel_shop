        ...
        <section class="flex flex-col lg:flex-row gap-10 xl:gap-14 2xl:gap-20 mt-12">
            ...
            <div class="basis-full lg:basis-2/5 xl:basis-2/4">
                <div class="overflow-hidden h-auto max-h-[620px] lg:h-[480px] xl:h-[620px] rounded-3xl">
                    <img src="{{$product->makeThumbnail('345x280')}}" class="object-cover w-full h-full" alt="SteelSeries Aerox 3 Snow">
                </div>
            </div>
            ...
            <section class="mt-16 xl:mt-24">
                ...
                @foreach($also as $product)
                    ...
                    <div class="product-card flex flex-col rounded-3xl bg-card">
                        <a href="{{$product->slug}}" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
                        ...
                        <div class="grow flex flex-col py-8 px-6">
                            <h3 class="text-sm lg:text-md font-black"><a href="{{$product->slug}}" class="inline-block text-white hover:text-pink">SteelSeries Aerox 3 Snow</a></h3>
